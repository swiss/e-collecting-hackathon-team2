...
<img width="2463" height="1394" alt="image" src="docs/eCollecting.png" />
...
| C1 | Das Komitee hat bei Initiativen laufend Zugriff auf den "eigenen" Tresor und kann den Fortschritt der Sammlung überprüfen. Zum Zeitpunkt X entscheidet das Komitee ob die Initiative der Kanzlei eingereicht oder zurückgezogen wird. |Komitee | 
| D1 | Die Kanzlei hat laufend Zugriff auf die eingereichten GUID von Referenden. Sie kann jederzeit prüfen und feststellen, ob ein Referendum die nötige Unterstützung erhalten hat. Bei einer Initiative entscheidet das Komitee, ob dieses eingereicht und damit für die Kanzlei freigeben wird. Ab diesem Zeitpunkt hat die Kanzlei Zugriff auf die Daten und kann das Zustandekommen einer Initiative prüfen und bestätigen. |Kanzlei | 
